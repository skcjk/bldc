...
void comm_can_send_status1(uint8_t id, bool replace) {
	...
	buffer_append_int16(buffer, (int16_t)(mc_interface_get_custom_kp() * 1e5), &send_index);
	buffer_append_int16(buffer, (int16_t)(mc_interface_get_custom_ki() * 1e5), &send_index);
